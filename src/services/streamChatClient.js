...
export const initializeChatClient = () => {
    return StreamChat.getInstance(process.env.STREAM_PB); // Replace with your Stream Chat API key
};
...
export const useChat = (session) => {
    ...
    initChat(); // Initialize chat client when the hook is called

    return chatClient; // Return the initialized chat client
};
